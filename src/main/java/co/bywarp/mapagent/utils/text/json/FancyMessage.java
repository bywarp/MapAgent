...
import static co.bywarp.mapagent.utils.text.json.TextualComponent.rawText;
 ...
 * It is set up such that invocations of property-setting methods will affect the getCurrent editing component,
...
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable {
	...
	/**
	 * Sets the text of the getCurrent editing component to a value.
	 *
	 * @param text The new text of the getCurrent editing component.
	...
	/**
	 * Sets the color of the getCurrent editing component to a value.
	 *
	 * @param color The new color of the getCurrent editing component.
	 * @return This builder instance.
	...
	/**
	 * Sets the stylization of the getCurrent editing component.
	 *
	...
	/**
	 * Set the behavior of the getCurrent editing component to instruct the client to open a file on the client side filesystem when the currently edited part of the {@code FancyMessage} is clicked.
	 *
	...
	/**
	 * Set the behavior of the getCurrent editing component to instruct the client to open a webpage in the client's web browser when the currently edited part of the {@code FancyMessage} is clicked.
	 *
	...
	/**
	 * Set the behavior of the getCurrent editing component to instruct the client to replace the chat input box content with the specified string when the currently edited part of the {@code FancyMessage} is clicked.
	...
	/**
	 * Set the behavior of the getCurrent editing component to instruct the client to append the chat input box content with the specified string when the currently edited part of the {@code FancyMessage} is SHIFT-CLICKED.
	 * The client will not immediately send the command to the server to be executed unless the client player submits the command/chat message, usually with the enter key.
	 *
	...
	/**
	 * Set the behavior of the getCurrent editing component to instruct the client to send the specified string to the server as a chat message when the currently edited part of the {@code FancyMessage} is clicked.
	...
	/**
	 * Set the behavior of the getCurrent editing component to display information about an achievement when the client hovers over the text.
	...
	/**
	 * Set the behavior of the getCurrent editing component to display raw text when the client hovers over the text.
	 * <p>Tooltips do not inherit display characteristics, such as color and styles, from the message component on which they are applied.</p>
	 *
	...
	/**
	 * Set the behavior of the getCurrent editing component to display formatted text when the client hovers over the text.
	 * <p>Tooltips do not inherit display characteristics, such as color and styles, from the message component on which they are applied.</p>
	 *
	...
	/**
	 * Set the behavior of the getCurrent editing component to display the specified lines of formatted text when the client hovers over the text.
	 * <p>Tooltips do not inherit display characteristics, such as color and styles, from the message component on which they are applied.</p>
	 *
	...
	*/
	...
	/**
	 * Terminate construction of the getCurrent editing component, and begin construction of a new message component.
